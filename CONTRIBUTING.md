# Contributing to E-HishabSathi Mobile

We welcome community contributions! Because `e-hishabsathi-mobile` uses a dual-licensing model, all contributors must agree to the Contributor License Agreement (CLA) before their code can be merged.
...
**How to sign:**
When opening a Pull Request, you must include the following line exactly as written in the PR description body:
`I have read and agree to the E-HishabSathi Contributor License Agreement.`
